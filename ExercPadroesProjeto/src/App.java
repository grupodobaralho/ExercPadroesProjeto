...
//		ano = Integer.parseInt(in.nextLine());
		...
		//Sabemos que o ideal eh limitar ao maximo a visao do usuario da parte interna do sistema,
		//sabemos que poderiamos esconder ainda mais o codigo do usuario, mas decidimos que
		//para este exercicio, estaria OK tratarmos tudo na classe de testes
		
		
		//Nao tratamos repeticoes de promocoes pois achamos que nao era a intencao do exercicio.
